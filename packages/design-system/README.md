...
surfaces (Ops Console, Admin workspace) and, for common component shapes only, the Mock Consumer.
...
use that shell shape (e.g. the Mock Consumer, which is a simple flowing page by design).
