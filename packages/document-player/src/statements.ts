/**
 * xAPI statement construction for the generic document (PowerPoint/Word-as-slides) player. Same
 * verb-reuse reasoning as video-player and audio-player: launched / answered(quartile) / completed,
 * no new verbs added to the Evidence API's accepted set.
 */
...
/** Furthest-page-reached quartile, e.g. quartile = 50 -> response "p50". */
