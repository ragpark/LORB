...
const ADMIN_ERROR_STATUS: Record<string, number> = {
  ...
  LEARNING_OBJECT_STATE_INVALID: 409,
  LEARNING_OBJECT_IN_USE: 409,
  LEARNING_OBJECT_DELIVERABLE: 409,
  LEARNING_OBJECT_CONTENT_UNSUPPORTED: 409,
  LEARNING_OBJECT_CONTENT_NOT_FOUND: 404,
...
const ADMIN_ERROR_TITLE: Record<string, string> = {
  ...
  LEARNING_OBJECT_STATE_INVALID: "This learning object is not in a state that allows that change",
  LEARNING_OBJECT_IN_USE: "This learning object has been launched or assigned, so it can be retired but not deleted",
  LEARNING_OBJECT_DELIVERABLE: "Suspend or retire this learning object before deleting it, so no launch can resolve it while it is removed",
  LEARNING_OBJECT_CONTENT_UNSUPPORTED: "This learning object's content is not editable here — publish a new package version instead",
  LEARNING_OBJECT_CONTENT_NOT_FOUND: "This learning object has no authored content",
